...
class Settings(BaseSettings):
    ...
    min_confidence: float = Field(default=0.25, alias="MIN_CONFIDENCE")
    volume_lookback: int = Field(default=20, alias="VOLUME_LOOKBACK")
    volume_spike_multiplier: float = Field(default=1.6, alias="VOLUME_SPIKE_MULTIPLIER")
    gap_threshold: float = Field(default=0.0015, alias="GAP_THRESHOLD")
    min_body_pct: float = Field(default=0.0015, alias="MIN_BODY_PCT")
    ...
    cooldown_minutes: int = Field(default=3, alias="COOLDOWN_MINUTES")
